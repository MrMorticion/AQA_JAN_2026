...
public class JUnitTests2HW {
    ...
    @ParameterizedTest
    @EnumSource(ExclusiveCarHW.class)
    public void carTest(ExclusiveCarHW car) {
        System.out.println(car.name());
        Assertions.assertFalse(car.equals(ExclusiveCarHW.EXCLUSIVE_CAR_3));
    }
