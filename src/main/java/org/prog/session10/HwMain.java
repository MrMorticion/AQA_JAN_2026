...
public class HwMain {
    public static void main(String[] args) {
        ...
        Apple brokenApple = new Apple(null, "Silver");
        System.out.println("brokenApple hash: " + brokenApple.hashCode());

        Android brokenAndroid = new Android("Pixel 9", null);
        System.out.println("android1 equals brokenAndroid: " + android1.equals(brokenAndroid));
    }
}